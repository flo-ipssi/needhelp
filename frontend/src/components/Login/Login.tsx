...
const Login: React.FC<Props> = ({ handleToken }) => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            ...
            if (typeof handleToken === "function") {
                handleToken(token);
            }
        } catch (error) {
    ...
    return (
        <>
            <div className="bg-yellow-400 h-screen w-screen min-w-full overflow-hidden flex items-center justify-center w-100">
